...
function toggleReply(separator, number, boardNumber) {
    ...
    $('#'+separator+'_'+number+'_reply').toggle()
    $('#'+separator+'_'+number+'_reply').load(
...
function ajaxForm(separator) {
    ...
    $("#" + separator + "_ajaxform").submit(function (e) {
        if (isWriting == false) {
            isWriting = true;
...
function ajaxForm_reply(separator, number) {
    ...
    $("#" + separator + "_" + number + "_ajaxform_reply").submit(function (e) {
        if (isReplying == false) {
            isReplying = true;
    ...
    $("#" + separator + "_" + number + "_ajaxform_reply").submit();
}
...
function ajaxForm_update(separator, number) {
    ...
    if(!isLogin() || !isEqualMember(number)){
        ...
        // 덧글 내용 초기화
        $("#" + separator + "_" + number + "_content_update").val("");
        return;
    }

    $("#" + separator + "_" + number + "_ajaxform_update").submit(function (e) {
        if (isUpdating == false) {
            isUpdating = true;
    ...
    $("#" + separator + "_" + number + "_ajaxform_update").submit();
}